...
#input_filename = input("Enter your inputfilename (no extension) : ")
input_filename = input("Enter your input filename (no extension): ")

filename = input("Enter your filename (no extension) : ")
...
for page in range(start,end+1):
    ...
    dfx = pd.read_excel(input_filename+'.xlsx')
